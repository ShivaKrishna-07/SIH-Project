...
app_mode = st.sidebar.selectbox("Select Page", ['Location-Based Crop Guide', 'Personalized Farming Plans'])


if(app_mode == "Location-Based Crop Guide"):
...
elif(app_mode == "Personalized Farming Plans"):
    st.title("Personalized Farming Plans")
    st.subheader("Tailored farming recommendations based on your location and needs")